---
title: "OneRep REST API & MCP Endpoint Overview"
sidebarTitle: "Overview"
description: "Access your training and nutrition log over HTTP or the Model Context Protocol — JSON in, JSON out, same keys, same scopes across both surfaces."
---
...
<CardGroup cols={2}>
  ...
  <Card title="MCP Endpoint" icon="robot" href="/api/mcp">
