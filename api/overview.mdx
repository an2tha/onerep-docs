...
`GET /v1` returns the full route list filtered to only the routes your key is allowed to call, which is useful when you are writing a new integration and want a quick reference without leaving your terminal.
