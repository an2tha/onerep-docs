...
- `tab` is also what files an unbound metric onto a Health dial: body to Body, nutrition to Nutrition, training to Activity. A metric with a `healthMetricKey` ignores it and files by the catalogue group of the signal it reads
...
- `tab` decides which Health dial an unbound metric files under: body to Body, nutrition to Nutrition, training to Activity. Bound metrics file by their catalogue group instead
