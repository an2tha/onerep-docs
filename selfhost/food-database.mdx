...
description: "Import USDA FoodData Central, Open Food Facts, and the wger exercise catalog. Each is independent, so you can import one, two, or all three."
---
...
<Tabs>
  ...
  <Tab title="wger Exercise Catalog">
    The wger catalog provides the exercise database used throughout the training features. Unlike the food catalogs, there is no file to download, because the importer fetches data directly from the wger API.
