...
The **Recent check-ins** list under the Body charts shows your last eight entries, newest first. Tap one to open the check-in sheet on that day with its numbers already filled in, correct what is wrong, and save. Tap the bin icon on a row to delete that check-in outright.
...
<Note>
  The sheet only writes the fields it shows. Correcting Tuesday's weight does not disturb the arm and thigh measurements recorded that day, and does not copy today's numbers onto it.
</Note>
